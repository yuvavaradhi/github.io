...
VALUES 
    ...
    ('22222222-2222-2222-2222-222222222222', 'education', 'Advanced Agronomy & Soil Science', 'EDU-AG-AGRO', 'Agricultural Engineering', 'Pedology, soil physical chemistry, nutrient management, and crop rotations.', ARRAY['icar', 'angrau', 'agronomy']),
    ('33333333-3333-3333-3333-333333333333', 'govt_jobs', 'APPSC Group-1 General Studies & Mental Ability', 'JOB-APPSC-GS', 'Civil Services Examination', 'State history, Indian polity, constitutional law, and analytical reasoning.', ARRAY['appsc', 'group1', 'gs']),
    ('44444444-4444-4444-4444-444444444444', 'govt_jobs', 'TGPSC Group-2 Economy & State Development', 'JOB-TGPSC-ECO', 'Civil Services Examination', 'Telangana economic policies, industrial hubs, and agricultural budgeting.', ARRAY['tgpsc', 'group2', 'economy']),
    ('55555555-5555-5555-5555-555555555555', 'agriculture', 'Cotton & Chilli Pest Integrated Management', 'AGR-PEST-IPM', 'Field Agronomy & Protection', 'Biological control, chemical dosage calculations, and threshold pest scouting.', ARRAY['kisan', 'pesticide', 'angrau']),
    ('66666666-6666-6666-6666-666666666666', 'agriculture', 'AP & TS Mandi Pricing & Market Economics', 'AGR-MKT-RADAR', 'Commodity Intelligence', 'Daily market arrivals, modal rates, minimum support prices, and storage economics.', ARRAY['mandi', 'market', 'kisan']),
    ('77777777-7777-7777-7777-777777777777', 'sports', 'Track & Field Athletics Coaching Syllabus', 'SPT-ATH-TRK', 'Olympic Track Disciplines', 'Sprint acceleration, relay baton transitions, long-distance stamina, and recovery.', ARRAY['saap', 'sats', 'athletics']),
